...
async function main() {
  ...
  // Step 2: Change password to DhiQarOwner2026!
  console.log('\n2. Changing password to DhiQarOwner2026!...');
  const changeRes = await request({
    ...
    newPassword: 'DhiQarOwner2026!' 
  });
  
  console.log('   Change Status:', changeRes.status);
  console.log('   Change Body:', changeRes.body);
  if (changeRes.status === 200) {
    console.log('\n🎉 Password successfully updated to DhiQarOwner2026! on election-system-production-437f.up.railway.app');
  } else {
