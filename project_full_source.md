...
.dark {
  ...
  --secondary: #b6c6ef;
  --secondary-foreground: #0c1424;
  --muted: #162238;
  --muted-foreground: #8aa0c2;
  --accent: #1e2e4a;
  ...
  --sidebar-primary: #fea619;
  --sidebar-primary-foreground: #031635;
  --sidebar-accent: #1a2b4b;
  --sidebar-accent-foreground: #fea619;
  --sidebar-border: #1e2e4a;
  --sidebar-ring: #fea619;

  /* Election system design tokens in dark mode */
  --el-primary: #fea619;
  --el-primary-container: #1e2e4a;
  --el-on-primary: #031635;
  --el-on-primary-container: #b6c6ef;
  --el-secondary: #ffb95f;
  --el-secondary-container: #fea619;
  --el-on-secondary: #3e2700;
  --el-on-secondary-container: #ffddb8;
  --el-tertiary-container: #ffddb8;
  --el-surface: #0c1424;
  --el-surface-container: #111d33;
  --el-surface-container-low: #090f1a;
  --el-surface-container-high: #162742;
  --el-surface-container-highest: #1e3354;
  --el-surface-variant: #1e2e4a;
  --el-outline: #8e95a5;
  --el-outline-variant: #2d3f5d;
  --el-error: #ffb4ab;
  --el-background: #050b14;
  --el-on-background: #f0f4f8;
  --el-on-surface: #f0f4f8;
  --el-on-surface-variant: #c2c9d6;
  --el-primary-fixed: #ffddb8;
  --el-primary-fixed-dim: #ffb95f;
  --el-on-primary-fixed: #3e2700;
  --el-on-primary-fixed-variant: #ffb95f;
  --el-secondary-fixed: #b6c6ef;
  --el-inverse-surface: #f0f4f8;
  --el-inverse-on-surface: #050b14;
  --el-error-container: #93000a;
  --el-surface-dim: #090f1a;
  --el-surface-bright: #162742;
  --el-surface-container-lowest: #070c17;
}
