...
async function main() {
  ...
  const login = await req({hostname:host,path:'/api/access',method:'POST',headers:{'Content-Type':'application/json'}},{action:'owner-login',ownerPassword:'YOUR_ADMIN_PASSWORD'});
